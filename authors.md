...
- **Madhan Kumar N**. Author, maintainer.

- **Siddhesh Pujari**. Author.

- **Gomathi S**. Author.

- **Mackenzie Haight**. Author.

## Citation

Source:
[`DESCRIPTION`](https://github.com/madhankumarnagaraji/dataviewR/blob/version1.1.0/DESCRIPTION)

Kumar N M, Pujari S, S G, Haight M (2026). *dataviewR: An Interactive
and Feature-Rich Data Viewer*. R package version 1.1.0,
