---
title: "Interactive Clinical Data Exploration with dataviewR"
format: html
author:
  - name: Madhan Kumar N
  - name: Siddhesh Pujari
description: "dataviewR is a Shiny-based interactive data viewer that joins the pharmaverse as a modern, feature-rich alternative to View() — with filtering, multi-dataset support, and automatic dplyr code generation built in."
...
**`dataviewR`** is a Shiny-based interactive data viewer, now part of the
[pharmaverse](https://pharmaverse.org/), built to extend `View()` with
the interactivity clinical programmers actually need: column-level
filtering with `dplyr` expressions, multi-dataset viewing, variable
...
## Feature 1: Filtering with dplyr Expressions
...
## Feature 3 : Reproducible Code Generation
