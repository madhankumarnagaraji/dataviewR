    ...
    meta_cols <- shiny::reactive({
      ...
      dplyr::left_join(class_df(), att_cols(), by = "colname") |>
        dplyr::mutate(col_name = dplyr::case_when(
          col_type == "int" ~ paste0("\u0023\uFE0F\u20E3 ", colname),
          col_type == "dbl" ~ paste0("\u0023\uFE0F\u20E3 ", colname),
          col_type == "chr" ~ paste0("\U0001F520 ", colname),
          col_type == "fct" ~ paste0("\U0001F520 ", colname),
          col_type == "lgl" ~ paste0("\U0001F501 ", colname),
          ...
          col_type == "time" ~ paste0("\U0001F552 ", colname),
          col_type == "drtn" ~ paste0("\U0001F552 ", colname),
          TRUE ~ paste0("\U0001F520 ", colname)
        )) |>
