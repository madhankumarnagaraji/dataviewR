...
test_that("Input Validation", {
  ...
  # Otherwise, the background process crashes silently
  # and the main function returns a PID
  expect_error(
...
test_that("Zero arguments handling", {
  ...
  expect_message(
    # User tries background, but no data forces foreground
    app <- dataviewer(background = TRUE),
