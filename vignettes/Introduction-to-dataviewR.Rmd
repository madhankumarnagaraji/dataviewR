...
---
<p align="right"> <img src="../man/figures/dataviewR_logo.png" width="180" alt="dataviewR logo"> </p>
...
`dataviewR` offers a flexible, dynamic interface that enables efficient and intuitive data exploration, whether within the viewer pane or through a standalone R Shiny application. `dataviewR` does not modify any values/attributes of the dataset(s) passed
